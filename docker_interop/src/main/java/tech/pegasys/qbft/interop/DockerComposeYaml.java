...
public class DockerComposeYaml {
  ...
  private Map<String, Object> addServices(
    ...
    for (int i = 0; i < besuNodeKeyPairs.size(); i++) {
      final DockerComposeService service =
          DockerComposeService.Builder.aDockerComposeService()
              .withIsBesuMode(true)
  ...
  private Map<String, Object> readTemplate() throws IOException {
    ...
    try (final InputStream yamlInputStream =
        getClass().getClassLoader().getResourceAsStream("docker-compose-template.yml")) {

...
public class DockerComposeService {
    private static final String BESU_COMMAND = "chmod 755 /scripts/run_besu.sh && /scripts/run_besu.sh";
    private static final String GO_QUORUM_COMMAND = "chmod 755 /scripts/run_geth.sh && /scripts/run_geth.sh";
    ...
    public Map<String, Object> getMap() {
        ...
        map.put("ports", List.of(p2pPort + ":" + p2pPort + "/tcp", p2pPort + ":" + p2pPort + "/udp", rpcPort + ":" + rpcPort));
    ...
    private String getCommand() {
        ...
        return String.format(commandFormat, isBesuMode ? BESU_COMMAND : GO_QUORUM_COMMAND, privateKey, p2pPort, rpcPort, staticNodeFileName);
    }
